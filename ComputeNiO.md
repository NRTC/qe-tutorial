...
سپس عبارت جدید Hubbard_alpha _در فایل های فوق وارد کرده و محاسبات را به ازای مقادیر مختلف آلفا \(0.15 \__ 0.07 _\__ 0.0 \__ 0.07- \_ 0.15- \) برای آن انجام می‌دهیم. این فایل نیز در هر دو محاسبه ni و o با یکدیگر متفاوت هستند . که در اینجا به تفاوت بین آنها اشاره می‌کنیم :  
...
1.26.2- محاسبه grepnalfa\_nio\_r16  
...
n3 = 5  
&end  
pos\_nio\_r16 باید به صورت زیر باشد

همانطور که مشاهده می‌کنیم در ستون آخر فایل pos\_nio\_r16 اعداد 1 ، 1- و 0 را مشاهده می‌کنیم که : \(1\) برای اسپین بالای  ni ، \(1-\) برای اسپین پایین ni ، \(0\) برای اسپین غیرقطبیده شده o  
