...
شکل 15 توضیحات  
و قسمت چهارم ATOMIC\_SPECIES جرم اتمی و نوع پتانسیل عنصر مورد استفاده را مشخص می‌کند که در فایل ps  دخیره شده است و در بخش انواع پتانسیل ها که شامل \(norm-conserving، ultrasoft و PAW\) به آن اشاره خواهیم کرد.  
